...
{
    public class GameObjectRenderEditor
    {
        ...
        public GameObjectRenderEditor(CameraEditor cameraEditor, GameObject gameObject)
        {
            ...
            _shaderProgramSelect.SetUniform("ProjectionMatrix", _cameraEditor.Camera.ProjectionMatrix);
            _shaderProgramSelect.SetUniform("ViewMatrix", _cameraEditor.Camera.ViewMatrix);
